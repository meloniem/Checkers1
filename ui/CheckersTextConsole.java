...
/**
 * Controls User Interface for Checkers Game. Starting point for program.
...
public class CheckersTextConsole {
	...
	public static CheckersLogic newPCGame(int difficultyLevel) {
		return new CheckersLogic(difficultyLevel);
		
	}
	/**
	 * Starts the game by taking user input to start game, followed by
	 * instantiating CheckersLogic object and prompting players for moves to make.
	 * @param args[] - main method args
	 * @throws NoSuchElementException - catches inadequate input.
	 */
